                            ...
                            <div className='md:flex pt-10 md:py-10'>
                                <div className='space-y-10'>
                                    ...
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <span className='text-xl'>Auto Title</span>
                                    </div>
                                ...
                                <div className='flex items-center gap-4'>
                                    ...
                                    <div className='flex items-center gap-4'>
                                        <Check className='text-3xl text-indigo-500 ' />
                                        <span className='text-xl'>Filter word removal</span>
                                    </div>

                                    <div className='flex items-center gap-4'>
                                        <Check className='text-3xl text-indigo-500 ' />
                                        <span className='text-xl'>Silent Removal</span>
                                    </div>
                                </div>
                            </div>
                            <Button className='
                                text-sm font-light w-40 rounded-[40px] 
